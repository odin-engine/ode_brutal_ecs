...
// Relations_Table
    ...
    relations_table__destroy_children__test :: proc(t: ^testing.T) {
        ...
        //
            ...
            testing.expect(t, ecs.table__init(&pos, &db, 20, {Rel_Pos}) == nil)
            ...
            for eid in all {
                testing.expect(t, ecs.table__add_entity(&pos, eid) == nil)
                ecs.get_component(&pos, eid, Rel_Pos)^ = { f64(eid.ix), 0 }
            }
            ...
            // Component table shrank by exactly the destroyed subtree
