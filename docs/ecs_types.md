...
## What type of ECS is ODE_BRUTAL_ECS?

ODE_BRUTAL_ECS is purely **archetype**-shaped:
* **Archetype Architecture:** Use [`Table`](table.md) for a fixed set of components that travel together.
