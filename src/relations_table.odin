/*
    ...
    Relations are not components: they carry no table-driven query support of
    their own. If you need to iterate "all entities with a parent",
    roots()/walk_hierarchy() below now cover that directly.
